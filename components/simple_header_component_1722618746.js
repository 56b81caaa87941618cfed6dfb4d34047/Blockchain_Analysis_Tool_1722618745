...
Vue.component("simple_header_component_1722618746", {
    template: `
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-opacity-30 backdrop-blur-md border-b border-pink-200 py-4 dark:bg-opacity-30 dark:backdrop-blur-md dark:border-purple-800">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-6 mx-auto">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-pink-600 bg-purple-100 rounded-lg lg:bg-transparent lg:text-pink-500 lg:p-0 dark:text-pink-400 lg:dark:text-pink-300" aria-current="page">Real-time Monitoring</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-purple-700 rounded-lg hover:bg-purple-100 lg:hover:bg-transparent lg:hover:text-pink-500 lg:p-0 dark:text-purple-300 lg:dark:hover:text-pink-400 dark:hover:bg-purple-800 dark:hover:text-pink-400 lg:dark:hover:bg-transparent">Advanced Data Analysis</a></li>
                        <li id="nav-item-2"><a href="#" class="block py-2 pl-3 pr-4 text-purple-700 rounded-lg hover:bg-purple-100 lg:hover:bg-transparent lg:hover:text-pink-500 lg:p-0 dark:text-purple-300 lg:dark:hover:text-pink-400 dark:hover:bg-purple-800 dark:hover:text-pink-400 lg:dark:hover:bg-transparent">Insightful Visualizations</a></li>
                        <li id="nav-item-3"><a href="#" class="block py-2 pl-3 pr-4 text-purple-700 rounded-lg hover:bg-purple-100 lg:hover:bg-transparent lg:hover:text-pink-500 lg:p-0 dark:text-purple-300 lg:dark:hover:text-pink-400 dark:hover:bg-purple-800 dark:hover:text-pink-400 lg:dark:hover:bg-transparent">Seamless Integration</a></li>
                    </ul>
                </div>
            </div>
        </nav>
